...
struct ABP_ConstructionLamp_03_C : ABP_LightMaster_C {
	...
	void UserConstructionScript(); // Function BP_ConstructionLamp_03.BP_ConstructionLamp_03_C.UserConstructionScript // (Event|Public|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0x16a87a0
};
