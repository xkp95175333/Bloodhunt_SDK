...
struct UTBP_UI_Battlepass_Button_Banner_C : UTigerWidget {
	...
	void OnLoaded_3063889143A813F7600FF1838B656080(struct UObject* Loaded); // Function TBP_UI_Battlepass_Button_Banner.TBP_UI_Battlepass_Button_Banner_C.OnLoaded_3063889143A813F7600FF1838B656080 // (BlueprintCallable|BlueprintEvent) // @ game+0x16a87a0
	void Construct(); // Function TBP_UI_Battlepass_Button_Banner.TBP_UI_Battlepass_Button_Banner_C.Construct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x16a87a0
	void Update Banner Button(); // Function TBP_UI_Battlepass_Button_Banner.TBP_UI_Battlepass_Button_Banner_C.Update Banner Button // (BlueprintCallable|BlueprintEvent) // @ game+0x16a87a0
	void ExecuteUbergraph_TBP_UI_Battlepass_Button_Banner(int32_t EntryPoint); // Function TBP_UI_Battlepass_Button_Banner.TBP_UI_Battlepass_Button_Banner_C.ExecuteUbergraph_TBP_UI_Battlepass_Button_Banner // (Final|UbergraphFunction|HasDefaults) // @ game+0x16a87a0
	void OnHovered__DelegateSignature(); // Function TBP_UI_Battlepass_Button_Banner.TBP_UI_Battlepass_Button_Banner_C.OnHovered__DelegateSignature // (Public|Delegate|BlueprintCallable|BlueprintEvent) // @ game+0x16a87a0
	void OnClick__DelegateSignature(); // Function TBP_UI_Battlepass_Button_Banner.TBP_UI_Battlepass_Button_Banner_C.OnClick__DelegateSignature // (Public|Delegate|BlueprintCallable|BlueprintEvent) // @ game+0x16a87a0
};
