...
struct UTBP_UI_Notification_Item_C : UTigerWidget {
	...
	void SetNewItem_Combat(struct FText Pre Text, struct UTexture2D* Texture, struct FText Post Text); // Function TBP_UI_Notification_Item.TBP_UI_Notification_Item_C.SetNewItem_Combat // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x16a87a0
	void SetNewItem(struct FText Item, struct UTexture2D* Texture); // Function TBP_UI_Notification_Item.TBP_UI_Notification_Item_C.SetNewItem // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x16a87a0
};
