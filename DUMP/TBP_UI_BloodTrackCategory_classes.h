...
struct UTBP_UI_BloodTrackCategory_C : UUserWidget {
	...
	void Fill(struct TArray<struct UTigerBloodTrackPassiveConfig*> Passives, struct TArray<struct UTigerBloodTrackPassiveConfig*> Passives To Exclude, struct UTBP_UI_BloodTrack_C* In Blood Track); // Function TBP_UI_BloodTrackCategory.TBP_UI_BloodTrackCategory_C.Fill // (Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0x16a87a0
	void Construct(); // Function TBP_UI_BloodTrackCategory.TBP_UI_BloodTrackCategory_C.Construct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x16a87a0
	void ExecuteUbergraph_TBP_UI_BloodTrackCategory(int32_t EntryPoint); // Function TBP_UI_BloodTrackCategory.TBP_UI_BloodTrackCategory_C.ExecuteUbergraph_TBP_UI_BloodTrackCategory // (Final|UbergraphFunction|HasDefaults) // @ game+0x16a87a0
};
