...
struct UTBP_UI_Tooltip_C : UTigerWidget {
	...
	void Construct(); // Function TBP_UI_Tooltip.TBP_UI_Tooltip_C.Construct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x16a87a0
	void Destruct(); // Function TBP_UI_Tooltip.TBP_UI_Tooltip_C.Destruct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x16a87a0
	void ExecuteUbergraph_TBP_UI_Tooltip(int32_t EntryPoint); // Function TBP_UI_Tooltip.TBP_UI_Tooltip_C.ExecuteUbergraph_TBP_UI_Tooltip // (Final|UbergraphFunction) // @ game+0x16a87a0
};
