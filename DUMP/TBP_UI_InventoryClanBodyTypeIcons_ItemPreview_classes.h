...
struct UTBP_UI_InventoryClanBodyTypeIcons_ItemPreview_C : UTigerWidget {
	...
	void SetOwnerIndicators(struct UTigerInventoryItemBase* InItem); // Function TBP_UI_InventoryClanBodyTypeIcons_ItemPreview.TBP_UI_InventoryClanBodyTypeIcons_ItemPreview_C.SetOwnerIndicators // (Public|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0x16a87a0
	void SetClanOrArchetypeIcon(struct TArray<enum class ETigerClan> InClans, struct TArray<enum class ETigerPowerKitType> InArchetypes); // Function TBP_UI_InventoryClanBodyTypeIcons_ItemPreview.TBP_UI_InventoryClanBodyTypeIcons_ItemPreview_C.SetClanOrArchetypeIcon // (Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0x16a87a0
	void CheckIfShouldDisplayDisallowedClan(struct TArray<enum class ETigerClan> InClans, struct TArray<enum class ETigerPowerKitType> InArchetypes, bool bSuccessful); // Function TBP_UI_InventoryClanBodyTypeIcons_ItemPreview.TBP_UI_InventoryClanBodyTypeIcons_ItemPreview_C.CheckIfShouldDisplayDisallowedClan // (Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0x16a87a0
	void Construct(); // Function TBP_UI_InventoryClanBodyTypeIcons_ItemPreview.TBP_UI_InventoryClanBodyTypeIcons_ItemPreview_C.Construct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x16a87a0
	void ExecuteUbergraph_TBP_UI_InventoryClanBodyTypeIcons_ItemPreview(int32_t EntryPoint); // Function TBP_UI_InventoryClanBodyTypeIcons_ItemPreview.TBP_UI_InventoryClanBodyTypeIcons_ItemPreview_C.ExecuteUbergraph_TBP_UI_InventoryClanBodyTypeIcons_ItemPreview // (Final|UbergraphFunction) // @ game+0x16a87a0
};
