...
struct UTBP_UI_Notification_Item_GroupInvite_C : UTigerWidget {
	...
	void Construct(); // Function TBP_UI_Notification_Item_GroupInvite.TBP_UI_Notification_Item_GroupInvite_C.Construct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x16a87a0
	void ExecuteUbergraph_TBP_UI_Notification_Item_GroupInvite(int32_t EntryPoint); // Function TBP_UI_Notification_Item_GroupInvite.TBP_UI_Notification_Item_GroupInvite_C.ExecuteUbergraph_TBP_UI_Notification_Item_GroupInvite // (Final|UbergraphFunction) // @ game+0x16a87a0
};
