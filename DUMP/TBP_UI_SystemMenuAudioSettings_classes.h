...
struct UTBP_UI_SystemMenuAudioSettings_C : UTigerMenuWidget {
	...
	struct UTBP_UI_CheckBox_C* UsePushToTalk; // 0x2e0(0x08)
	struct UTBP_UI_SliderWBox_C* VideoVolumeSlider; // 0x2e8(0x08)
	struct UTBP_UI_SliderWBox_C* VoiceChatVolumeSlider; // 0x2f0(0x08)
	struct UTBP_UI_SystemMenuItem_C* CurrentlySelectedSystemMenuItem; // 0x2f8(0x08)

	void UpdateVolumeSettings(); // Function TBP_UI_SystemMenuAudioSettings.TBP_UI_SystemMenuAudioSettings_C.UpdateVolumeSettings // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x16a87a0
	void Update Voip Settings(); // Function TBP_UI_SystemMenuAudioSettings.TBP_UI_SystemMenuAudioSettings_C.Update Voip Settings // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x16a87a0
	void Construct(); // Function TBP_UI_SystemMenuAudioSettings.TBP_UI_SystemMenuAudioSettings_C.Construct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x16a87a0
	void OnOpen(); // Function TBP_UI_SystemMenuAudioSettings.TBP_UI_SystemMenuAudioSettings_C.OnOpen // (Event|Protected|BlueprintEvent) // @ game+0x16a87a0
	...
	void ExecuteUbergraph_TBP_UI_SystemMenuAudioSettings(int32_t EntryPoint); // Function TBP_UI_SystemMenuAudioSettings.TBP_UI_SystemMenuAudioSettings_C.ExecuteUbergraph_TBP_UI_SystemMenuAudioSettings // (Final|UbergraphFunction) // @ game+0x16a87a0
};
