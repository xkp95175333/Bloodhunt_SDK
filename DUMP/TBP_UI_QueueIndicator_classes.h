...
struct UTBP_UI_QueueIndicator_C : UUserWidget {
	...
	void Construct(); // Function TBP_UI_QueueIndicator.TBP_UI_QueueIndicator_C.Construct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x16a87a0
	void PreConstruct(bool IsDesignTime); // Function TBP_UI_QueueIndicator.TBP_UI_QueueIndicator_C.PreConstruct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x16a87a0
	void ExecuteUbergraph_TBP_UI_QueueIndicator(int32_t EntryPoint); // Function TBP_UI_QueueIndicator.TBP_UI_QueueIndicator_C.ExecuteUbergraph_TBP_UI_QueueIndicator // (Final|UbergraphFunction) // @ game+0x16a87a0
};
