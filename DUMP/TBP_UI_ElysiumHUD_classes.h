...
struct UTBP_UI_ElysiumHUD_C : UTigerWidget {
	...
	void Construct(); // Function TBP_UI_ElysiumHUD.TBP_UI_ElysiumHUD_C.Construct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x16a87a0
	void Toggle Visibility(); // Function TBP_UI_ElysiumHUD.TBP_UI_ElysiumHUD_C.Toggle Visibility // (BlueprintCallable|BlueprintEvent) // @ game+0x16a87a0
	void ExecuteUbergraph_TBP_UI_ElysiumHUD(int32_t EntryPoint); // Function TBP_UI_ElysiumHUD.TBP_UI_ElysiumHUD_C.ExecuteUbergraph_TBP_UI_ElysiumHUD // (Final|UbergraphFunction|HasDefaults) // @ game+0x16a87a0
};
