...
struct ABP_Candle_01_C : AActor {
	...
	float Random from world(int32_t NewParam); // Function BP_Candle_01.BP_Candle_01_C.Random from world // (Public|HasOutParms|BlueprintCallable|BlueprintEvent) // @ game+0x16a87a0
	void UserConstructionScript(); // Function BP_Candle_01.BP_Candle_01_C.UserConstructionScript // (Event|Public|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0x16a87a0
};
