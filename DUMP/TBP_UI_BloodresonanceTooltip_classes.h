...
struct UTBP_UI_BloodResonanceTooltip_C : UTigerTooltipWidget {
	...
	void SetBloodType(enum class ETigerBloodType InBloodType); // Function TBP_UI_BloodresonanceTooltip.TBP_UI_BloodResonanceTooltip_C.SetBloodType // (Public|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0x16a87a0
	void OnBloodResonanceAdded(enum class ETigerBloodType InBloodType); // Function TBP_UI_BloodresonanceTooltip.TBP_UI_BloodResonanceTooltip_C.OnBloodResonanceAdded // (BlueprintCallable|BlueprintEvent) // @ game+0x16a87a0
	void Construct(); // Function TBP_UI_BloodresonanceTooltip.TBP_UI_BloodResonanceTooltip_C.Construct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x16a87a0
	void OnBloodResonanceWasCappedAfterFeed(enum class ETigerBloodType InBloodType, enum class ETigerBloodResonanceBlockType InBlockType); // Function TBP_UI_BloodresonanceTooltip.TBP_UI_BloodResonanceTooltip_C.OnBloodResonanceWasCappedAfterFeed // (BlueprintCallable|BlueprintEvent) // @ game+0x16a87a0
	void ExecuteUbergraph_TBP_UI_BloodResonanceTooltip(int32_t EntryPoint); // Function TBP_UI_BloodresonanceTooltip.TBP_UI_BloodResonanceTooltip_C.ExecuteUbergraph_TBP_UI_BloodResonanceTooltip // (Final|UbergraphFunction) // @ game+0x16a87a0
};
