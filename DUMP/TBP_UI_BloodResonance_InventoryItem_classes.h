...
struct UTBP_UI_BloodResonance_InventoryItem_C : UTigerWidget {
	...
	void UpdateStatusAndInfo(struct FText TextDesc); // Function TBP_UI_BloodResonance_InventoryItem.TBP_UI_BloodResonance_InventoryItem_C.UpdateStatusAndInfo // (HasOutParms|BlueprintCallable|BlueprintEvent) // @ game+0x16a87a0
	void InitializeInventoryResonance(struct FText InResonanceName, struct FLinearColor InResonanceColor, struct TSoftObjectPtr<struct UTexture2D> InResonanceIcon, struct TSoftObjectPtr<struct UTexture2D> InResonanceVFX, enum class ETigerBloodType InBloodType); // Function TBP_UI_BloodResonance_InventoryItem.TBP_UI_BloodResonance_InventoryItem_C.InitializeInventoryResonance // (BlueprintCallable|BlueprintEvent) // @ game+0x16a87a0
	void ExecuteUbergraph_TBP_UI_BloodResonance_InventoryItem(int32_t EntryPoint); // Function TBP_UI_BloodResonance_InventoryItem.TBP_UI_BloodResonance_InventoryItem_C.ExecuteUbergraph_TBP_UI_BloodResonance_InventoryItem // (Final|UbergraphFunction|HasDefaults) // @ game+0x16a87a0
};
