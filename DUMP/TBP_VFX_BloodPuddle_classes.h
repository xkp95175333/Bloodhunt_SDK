...
struct ATBP_VFX_BloodPuddle_C : AActor {
	...
	void Timeline_0__FinishedFunc(); // Function TBP_VFX_BloodPuddle.TBP_VFX_BloodPuddle_C.Timeline_0__FinishedFunc // (BlueprintEvent) // @ game+0x16a87a0
	void Timeline_0__UpdateFunc(); // Function TBP_VFX_BloodPuddle.TBP_VFX_BloodPuddle_C.Timeline_0__UpdateFunc // (BlueprintEvent) // @ game+0x16a87a0
	void ReceiveBeginPlay(); // Function TBP_VFX_BloodPuddle.TBP_VFX_BloodPuddle_C.ReceiveBeginPlay // (Event|Protected|BlueprintEvent) // @ game+0x16a87a0
	void ExecuteUbergraph_TBP_VFX_BloodPuddle(int32_t EntryPoint); // Function TBP_VFX_BloodPuddle.TBP_VFX_BloodPuddle_C.ExecuteUbergraph_TBP_VFX_BloodPuddle // (Final|UbergraphFunction) // @ game+0x16a87a0
};
