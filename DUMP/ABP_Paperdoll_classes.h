...
struct UABP_Paperdoll_C : UTigerPaperDollAnimInstance {
	...
	void AnimGraph(struct FPoseLink AnimGraph); // Function ABP_Paperdoll.ABP_Paperdoll_C.AnimGraph // (HasOutParms|BlueprintCallable|BlueprintEvent) // @ game+0x16a87a0
	void FacialAnimations(); // Function ABP_Paperdoll.ABP_Paperdoll_C.FacialAnimations // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x16a87a0
	void SelectAnimationSets(struct UTigerAnimationSetCollection* Set Collection); // Function ABP_Paperdoll.ABP_Paperdoll_C.SelectAnimationSets // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x16a87a0
	...
	void AddSets(struct UTigerAnimationSetCollection* SetCollection); // Function ABP_Paperdoll.ABP_Paperdoll_C.AddSets // (Event|Protected|BlueprintEvent) // @ game+0x16a87a0
	void BlueprintUpdateAnimation(float DeltaTimeX); // Function ABP_Paperdoll.ABP_Paperdoll_C.BlueprintUpdateAnimation // (Event|Public|BlueprintEvent) // @ game+0x16a87a0
	void BlueprintInitializeAnimation(); // Function ABP_Paperdoll.ABP_Paperdoll_C.BlueprintInitializeAnimation // (Event|Public|BlueprintEvent) // @ game+0x16a87a0
	void ExecuteUbergraph_ABP_Paperdoll(int32_t EntryPoint); // Function ABP_Paperdoll.ABP_Paperdoll_C.ExecuteUbergraph_ABP_Paperdoll // (Final|UbergraphFunction) // @ game+0x16a87a0
};
