// BlueprintGeneratedClass TBP_XP_KilledPlayer.TBP_XP_KilledPlayer_C
// Size: 0x5c (Inherited: 0x50)
struct UTBP_XP_KilledPlayer_C : UTigerExperienceEvent {
