...
struct ABP_SmallSpotlLight_01_C : AActor {
	...
	void LightSetup(struct UTigerSpotLightComponent* LightToKeep, struct UTigerSpotLightComponent* LightToDestroy); // Function BP_SmallSpotlLight_01.BP_SmallSpotlLight_01_C.LightSetup // (Public|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0x16a87a0
	void SetCustomPrimitiveData(); // Function BP_SmallSpotlLight_01.BP_SmallSpotlLight_01_C.SetCustomPrimitiveData // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x16a87a0
	void UserConstructionScript(); // Function BP_SmallSpotlLight_01.BP_SmallSpotlLight_01_C.UserConstructionScript // (Event|Public|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0x16a87a0
};
