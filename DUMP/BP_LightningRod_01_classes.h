...
struct ABP_LightningRod_01_C : ATBP_WeatherPS_01_C {
	...
	void AddMiddleComponent(int32_t InIndex); // Function BP_LightningRod_01.BP_LightningRod_01_C.AddMiddleComponent // (Public|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0x16a87a0
	void UserConstructionScript(); // Function BP_LightningRod_01.BP_LightningRod_01_C.UserConstructionScript // (Event|Public|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0x16a87a0
};
