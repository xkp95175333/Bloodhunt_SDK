...
struct UTBP_UI_Tag_C : UUserWidget {
	...
	void PreConstruct(bool IsDesignTime); // Function TBP_UI_Tag.TBP_UI_Tag_C.PreConstruct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x16a87a0
	void ExecuteUbergraph_TBP_UI_Tag(int32_t EntryPoint); // Function TBP_UI_Tag.TBP_UI_Tag_C.ExecuteUbergraph_TBP_UI_Tag // (Final|UbergraphFunction) // @ game+0x16a87a0
};
