...
struct UTBP_UI_HitMarker_C : UTigerWidget {
	...
	void IsShown(bool bOutIsShown); // Function TBP_UI_HitMarker.TBP_UI_HitMarker_C.IsShown // (Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure) // @ game+0x16a87a0
	void ShowHitMarker(struct FLinearColor In Hit Marker Color, bool bPlayerWasDownedOrKilled); // Function TBP_UI_HitMarker.TBP_UI_HitMarker_C.ShowHitMarker // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x16a87a0
	void Tick(struct FGeometry MyGeometry, float InDeltaTime); // Function TBP_UI_HitMarker.TBP_UI_HitMarker_C.Tick // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x16a87a0
	void Construct(); // Function TBP_UI_HitMarker.TBP_UI_HitMarker_C.Construct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x16a87a0
	void ExecuteUbergraph_TBP_UI_HitMarker(int32_t EntryPoint); // Function TBP_UI_HitMarker.TBP_UI_HitMarker_C.ExecuteUbergraph_TBP_UI_HitMarker // (Final|UbergraphFunction|HasDefaults) // @ game+0x16a87a0
};
