...
struct UTBP_UI_BloodResonance_Inventory_C : UTigerWidget {
	...
	void UpdateInventoryResonance(struct UTBP_UI_BloodResonance_InventoryItem_C* InTarget, struct UTigerBloodResonanceAsset* InDataAsset, enum class ETigerBloodType InBloodType); // Function TBP_UI_BloodResonance_Inventory.TBP_UI_BloodResonance_Inventory_C.UpdateInventoryResonance // (Public|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0x16a87a0
	void InitializeInventoryResonance(struct UTBP_UI_BloodResonance_InventoryItem_C* InTarget, struct UTigerBloodResonanceAsset* InDataAsset, enum class ETigerBloodType InBloodType); // Function TBP_UI_BloodResonance_Inventory.TBP_UI_BloodResonance_Inventory_C.InitializeInventoryResonance // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x16a87a0
	void UpdateInfo(); // Function TBP_UI_BloodResonance_Inventory.TBP_UI_BloodResonance_Inventory_C.UpdateInfo // (BlueprintCallable|BlueprintEvent) // @ game+0x16a87a0
	void ExecuteUbergraph_TBP_UI_BloodResonance_Inventory(int32_t EntryPoint); // Function TBP_UI_BloodResonance_Inventory.TBP_UI_BloodResonance_Inventory_C.ExecuteUbergraph_TBP_UI_BloodResonance_Inventory // (Final|UbergraphFunction|HasDefaults) // @ game+0x16a87a0
};
